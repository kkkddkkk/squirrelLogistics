...
// import { deleteNotice, toggleNotice } from "../api/noticeAPI";
...
export default function NoticeCard({ notice, isAdmin, refresh }) {
  ...
  const handleToggle = async () => {
    // await toggleNotice(notice.noticeId, !notice.pinned);
    refresh();
  };
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
              <PushPinIcon
                ...
                sx={{
                  ...
                  color: notice.pinned ? thisTheme.palette.primary.main : 'inherit',
                  flex: '0 0 auto',
                }}
                titleAccess="고정됨"
          ...
          {isAdmin && (
            <Grid item>
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Button variant="outlined" color={thisTheme.palette.error.main} size="small" onClick={handleDelete}
                  sx={(t) => ({
